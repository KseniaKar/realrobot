...
_ENTRANCE_LOT = {
    ...
    # NSI-коды из API investmoscow
    "nsi:1032:103201":  "отдельный с улицы",
    "nsi:1032:1032004": "общий с улицы",
    "nsi:1032:1032005": "общий с улицы",
    "nsi:1032:1032006": "общий с улицы",
    # nsi:1032:9001302 — сайт не показывает тип входа → None (не добавляем)
}
