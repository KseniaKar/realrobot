...
csv_data = filtered[["номер_лота", "адрес", "площадь_м²", "начальная_цена_руб",
                      "итоговая_цена_руб", "превышение_цены_%", "исключить_из_ценовой_статистики", "этаж_норм", "метро",
...
filtered["отказ_победителя"] = filtered["исключить_из_ценовой_статистики"].map({True: "Да", False: "Нет"})
...
display_cols = [
    "превышение_display", "отказ_победителя", "участники", "ссылка_на_лот", "номер_лота", "адрес", "площадь_м²",
...
st.dataframe(
    ...
    column_config={
        ...
        "отказ_победителя": "Отказ победителя",
        "участники": "Участники",
