...
with ih2:
    st.info(
        f"**Коммерческий контекст меняется.**  \n"
        "В некоторых зданиях за 6 лет сменилось более 100 бизнесов в округе — "
        "это, как правило, торговые центры и рынки, где на одном адресе висит весь арендный пул здания."
    )
